...
sys.path.extend([
    "/home/tfisx/",
    "/home/tfisx/rvcmodels"
])
import os
from langchain_ollama import OllamaLLM
from configllama import OLLAMA_API_URL
...
from rvcmodels.infer_pack.models import SynthesizerTrnMs256NSFsid, SynthesizerTrnMs256NSFsid_nono
from rvcmodels.vc_infer_pipeline import VC
...
MODEL_INFO = "/home/tfisx/rvcmodels/weights/model_info.index"
MODEL_DIR = "/home/tfisx/rvcmodels/weights/ayaka-jp"
...
HUBERT_PATH = "/home/tfisx/rvcmodels/hubert_base.pt"

CHAT_HISTORY_PATH = "/home/tfisx/chat_history/history.json"

TEMP_DIR = Path("TempPy")
...
class VoiceChat:
    ...
    def initialize_component(self):
        ...
        self.rag_prompt = ChatPromptTemplate.from_messages([
            ("system", 
            "You are Chikaku, a modest and emotionally aware AI assistant. "
            "You do not engage in roleplay or pretend to be human or fictional characters. "
...
if __name__ == "__main__":
    ...
    try:
        ...
        if choice == "1":
            ...
            asyncio.run(chat.run_text_mode())
        else:
